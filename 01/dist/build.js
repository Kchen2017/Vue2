...
new _vue2.default({
	el: "#root",
	render: function render(creater) {
		return creater(_app2.default);
	}
});
...
var render = function() {
  ...
  return _c("div", [
    ...
    _c(
      "ul",
      _vm._l(_vm.stus, function(stu) {
        return _c("li", { key: stu.id }, [
          _vm._v(
            "\n                " +
              _vm._s(stu.name) +
              "\n                " +
    ...
    _vm._v(" "),
    _c("button", { on: { click: _vm.changeStu } }, [_vm._v("点击更换学生")])
  ])
}
var staticRenderFns = []
